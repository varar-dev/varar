...
test('unbundled dist (V8): skips internal frames, returns the caller module', () => {
  const stack = [
    'Error: locate',
    '    at callerLocation (/repo/typescript/packages/varar/dist/internal.js:400:15)',
    '    at registerStep (/repo/typescript/packages/varar/dist/internal.js:30:20)',
    '    at Object.stimulus (/repo/typescript/packages/varar/dist/internal.js:250:10)',
