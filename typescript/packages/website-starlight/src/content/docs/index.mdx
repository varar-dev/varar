...
<Tabs syncKey="example">
  <TabItem label="Yahtzee">
    <Editor uri="file:///yahtzee.md" chrome group="yahtzee" steps={[{ path: 'yahtzee.steps.ts', source: yahtzeeSteps }]}>{yahtzeeSource}</Editor>
  </TabItem>
  <TabItem label="Roman numerals">
    <Editor uri="file:///roman-numerals.md" chrome group="roman-numerals" steps={[{ path: 'roman-numerals.steps.ts', source: romanNumeralsSteps }]}>{romanNumeralsSource}</Editor>
  </TabItem>
</Tabs>
