...
Not a snippet — the whole file, unmodified, running in this repo's own test suite. Edit it:

<Editor uri="file:///yahtzee.md" chrome lineNumbers folding group="yahtzee" steps={[{ path: 'yahtzee.steps.ts', source: yahtzeeSteps }]}>{yahtzeeSource}</Editor>
