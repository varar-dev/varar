  ...
  module Var
    module Core
      ...
      RSpec.describe Drifts do
        ...
        memory_store = Class.new do
          attr_accessor :contents

          def initialize(initial = nil) = (@contents = initial)
          def read = @contents
        ...
        it "records one entry per example-producing paragraph" do
          ...
          expect(described_class.live_examples(var_doc, plan)).to eq([BaselineExample.new(name: "I withdraw 40", line: 1)])
        end
