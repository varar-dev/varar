"""test_doc_string_diff.py — port of typescript/packages/var-core/tests/doc-string-diff.test.ts"""
from __future__ import annotations

import pytest

from var.cell_diff import ReturnShapeError
from var.doc_string_diff import (
...
def test_doc_string_mismatch_error_carries_diff_and_is_detectable() -> None:
    from var.doc_string_diff import DocStringDiff
