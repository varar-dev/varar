 ...
 * by {@link OathFileSelectorResolver}, at discovery time. One {@link ExampleDescriptor} child is
 ...
 * synchronization. Each {@link ExampleDescriptor} leaf looks its own {@link Run.ExampleRun} up
 ...
 */
final class OathFileDescriptor extends AbstractTestDescriptor implements Node<OathEngineExecutionContext> {
     ...
     * from the real {@code ExecutionRequest} by {@link OathTestEngine#createExecutionContext} —
     ...
     * to one of this file's {@link ExampleDescriptor} children would require matching span
     ...
     */
    private void publishDiagnostics(OathEngineExecutionContext context, List<Diagnostics.Diagnostic> diagnostics) {
