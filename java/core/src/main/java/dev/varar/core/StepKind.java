 ...
 * (and {@code typescript/packages/core/src/step-role.ts}'s {@code StepKind} union type):
 *
 * <ul>
 ...
 * design doc's module map: step-role/registry logic belongs in {@code varar-core} (the
